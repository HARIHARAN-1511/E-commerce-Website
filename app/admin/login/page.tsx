                ...
                <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-xl">
                    {resetSent ? (
                        ...
                        <form onSubmit={isResetting ? handleResetPassword : handleLogin} className="space-y-6">
                            <div>
                                <label className="block text-sm font-bold mb-2 uppercase tracking-wide text-slate-500">Admin Email</label>
                            ...
                            {!isResetting && (
                                <div>
                                    <div className="flex justify-between items-end mb-2">
                                        <label className="text-sm font-bold uppercase tracking-wide text-slate-500">Secret Key</label>
                                        <button
                                            type="button"
