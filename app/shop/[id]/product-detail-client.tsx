...
import { ArrowLeft, ShoppingCart, ShieldCheck, Package, RefreshCcw } from "lucide-react"
                ...
                <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide">
                  {gallery.map((img, idx) => (
                    <button
                      ...
                      className={`relative w-24 h-24 flex-shrink-0 rounded-2xl overflow-hidden border-2 transition-all ${activeImage === img ? "border-primary ring-4 ring-primary/10 scale-105" : "border-transparent opacity-60 hover:opacity-100"
                        }`}
                    >
                      <Image
                        src={img}
