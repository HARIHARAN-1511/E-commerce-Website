                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-50 pl-12 pr-6 py-4 rounded-2xl border border-transparent focus:border-primary focus:bg-white transition-all outline-none font-medium text-sm text-slate-900"
                            ...
                            {!isResetting && (
                                <div>
                                    <div className="flex justify-between items-end mb-2">
                                        <label className="text-sm font-bold uppercase tracking-wide text-slate-500">Password</label>
                                        <button
                                            type="button"
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-50 pl-12 pr-12 py-4 rounded-2xl border border-transparent focus:border-primary focus:bg-white transition-all outline-none font-medium text-sm text-slate-900"
                                            placeholder="••••••••"
                                        />
                                        <button
                                            type="button"
